"""
Render the 5OB1CC lab to a static HTML file.
...
Open labs/build/5OB.html directly, or serve the directory:
...
STRATEGY_DIR = REPO_ROOT / "strategies" / "5OB1CC"
sys.path.insert(0, str(STRATEGY_DIR))

from utils.order_block import load_data  # noqa: E402
from utils.report import render_error_to_file, render_to_file  # noqa: E402

DEFAULT_OUT = REPO_ROOT / "labs" / "build" / "5OB.html"
