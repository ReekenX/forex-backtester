"""
Render the 30MCR lab to a static HTML file.

    poetry run python labs/render_30MCR.py

Same page as labs/render.py builds for 15LS1CC, fed from this strategy's CSV.
...
Open labs/build/30MCR.html directly, or serve the directory:
...
STRATEGY_DIR = REPO_ROOT / "strategies" / "30MCR"
sys.path.insert(0, str(STRATEGY_DIR))

from utils.continuation_reversal import load_data  # noqa: E402
from utils.report import render_error_to_file, render_to_file  # noqa: E402

DEFAULT_OUT = REPO_ROOT / "labs" / "build" / "30MCR.html"
...
def main(argv):
    ...
    try:
        df = load_data(str(STRATEGY_DIR / "trades.csv"))
